...
int main(){
    ...
    for(int i = 0; i < N; i++){
        for(int j = 0; j < N; j++){
                        ...
                        for(int l = 0; l < 2; l++){//immediate below
                            for(int m = 0; m < 2; m++){//left
                                for(int n = 0; n < 2; n++){//below
                                    if(!(k == 1 && m == 0) && !(l == 1 && n == 0))
                                        dp[i][j][0][1][0][1][1] += dp[i][j - 1][k][l][m][n][1];
                                }
                            }
                        }
                    }
                    ...
                    for(int k = 0; k < 2; k++){//immediate left
                        for(int l = 0; l < 2; l++){//immediate below
                            for(int m = 0; m < 2; m++){//left
                                for(int n = 0; n < 2; n++){//below
                                    if(!(k == 1 && m == 0) && !(l == 1 && n == 0))
                                        dp[i][j][1][0][1][0][1] += dp[i - 1][j][k][l][m][n][1];
                                }
                            }
                        }
                    }
            ...
            //something not to immediate left or below
            // for(int k = 0; k < i; k++){
            //     for(int l = 0; l < j; l++){
            //         for(int m = 0; m < 2; m++){
            //             for(int n = 0; n < 2; n++){
            //                 dp[i][j][0][0][1][1][0] += dp[k][j][m][1][m][1][1] * dp[i][l][1][n][1][n][1];
            //                 temp += dp[k][j][m][1][m][1][1] * dp[i][l][1][n][1][n][1];
            //             }
            //         }
            //     }
            // }
